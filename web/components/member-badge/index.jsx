...
export default class MemberBadge extends React.Component {
  ...
  render() {
    const { className = '', groupLevel, groupName, hasBg, groupNameStyle, memberBadgeStyle } = this.props;
    return (
      <div className={classnames(className, styles.memberBadgeBox, hasBg ? styles.bg : styles.default)} style={memberBadgeStyle}>
